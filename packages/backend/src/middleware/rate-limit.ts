...
export const strictLimiter = rateLimit({
  ...
  message: 'Too many upload/analysis requests, please try again later',
...
export const analysisLimiter = rateLimit({
  ...
  message: 'Analysis rate limit exceeded. Please wait before running more analyses.',
  standardHeaders: true,
  legacyHeaders: false,
  // Skip successful requests if they complete quickly (not counted against limit)
