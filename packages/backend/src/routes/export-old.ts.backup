...
<body>
  ...
  <div class="footer">
    <p><strong>🤖 BSR Quality Checker</strong> • AI-Powered Building Safety Analysis</p>
    <p>Generated by AI in seconds, not hours. All findings should be reviewed by qualified professionals.</p>
  </div>
</body>
</html>
  `.trim();
...
<body>
  ...
  <div class="footer">
    <p><strong>🤖 BSR Quality Checker</strong> • AI-Powered Issue Analysis</p>
    <p>AI-identified issues requiring human review. Automated analysis saves hours of manual document review.</p>
  </div>
</body>
</html>
  `.trim();
...
<body>
  <div class="header">
    ...
    <div class="subtitle">🤖 AI-Powered Analysis • Generated: ${new Date().toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}</div>
  </div>
  ...
  <div class="footer">
    <p><strong>🤖 BSR Quality Checker</strong> • AI-Powered Compliance Analysis</p>
    <p>This report was generated by AI in seconds. Traditional consultancies take hours to produce similar compliance matrices.</p>
  </div>
</body>
</html>
  `.trim();
