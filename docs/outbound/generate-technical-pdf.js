...
async function generatePDF() {
  const htmlPath = path.join(__dirname, 'full-technical-process.html');
  const outputPath = path.join(__dirname, 'full-technical-process.pdf');
    ...
    await page.pdf({
      ...
      headerTemplate: `
        <div style="font-size: 9px; width: 100%; text-align: center; color: #666; margin-top: 10px;">
          Complete End-to-End Technical Process - Attlee BSR Quality Checker
        </div>
      `,
      footerTemplate: `
